...
'''
Las pruebas de regresión son las que se encargan de probar todo el sistema.
...
Como siguiente punto los test de esta clase, vemos que utilizan tanto la libería de pytest para ejecutarlos y desarrollarlos así como también la asistencia de la librería
"Requests" para realizar las peticiones en el tiempo de ejecución de los test para poder evaluar los resultados.

Volviendo específicamente a las funcionalidades dadas, nos encontramos con la creación y login de un nuevo usuario. En esta oportunidad reutilizaremos la lógica de
la creación de usuario y login para obtener el token ya que
...
def test_sqli(setup_create_user):
    ...
    '''
    Creo la consulta para verificar la vulnerabildad,
